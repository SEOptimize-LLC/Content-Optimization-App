...
# Import V2 optimizers
try:
    from core.entity_context_extractor import extract_entity_context
    from core.outline_optimizer_v2 import optimize_outline
    from core.draft_optimizer_v2 import optimize_draft
    print("SUCCESS: V2 optimizers loaded")
except Exception as e:
    print(f"ERROR loading V2 optimizers: {e}")
    traceback.print_exc()
