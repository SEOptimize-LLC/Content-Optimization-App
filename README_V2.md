...
**New V2 Interface (4-Step Workflow):**
```bash
...
├── app_v2.py                           # New 4-step workflow UI ⭐
...
│   ├── outline_optimizer_v2.py        # Complete outline pipeline
│   ├── draft_optimizer_v2.py          # Complete draft pipeline
│   ├── google_api_config.py           # Google Cloud API integration
│   ├── outline_optimizer.py           # Legacy
│   ├── draft_optimizer.py             # Legacy
